...
import { loginSchema, LoginFormData } from '@/utils/validators/auth.schemas';
...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      setServerError(errorMsg || 'Login failed.');
      toast.error(errorMsg || 'Login failed.');
    }
  };

  const handleGoogleLogin = () => {
    toast.success('Redirecting to Google SSO authorization...');
  };
