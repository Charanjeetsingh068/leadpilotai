      ...
      if (res.data?.data?.leads && Array.isArray(res.data.data.leads) && res.data.data.leads.length > 0) {
        ...
        const mappedLeads: Lead[] = rawLeads.map((l: any) => {
          ...
          return {
            ...
            phone: l.phone || '+91 98100 12345',
            email: l.email || '',
            source: src,
            campaign: l.campaign || l.campaignName || 'Meta Leads Center Campaign',
            project: l.project || l.formName || 'Meta Business Suite Project',
            industry: l.industry || 'Real Estate',
            budget: l.budget || 'Standard Budget',
            location: l.location || l.city || 'Delhi NCR',
            status: st,
            qualificationScore: typeof l.qualificationScore === 'number' ? l.qualificationScore : 85,
            assignedSalesUser: l.assignedSalesUser || null,
            organizationId: l.organizationId || l.workspaceId || 'org_leadpilot_demo',
